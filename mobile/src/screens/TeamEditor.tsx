  ...
  return (
    <Screen>
      <ScreenHeader
        ...
        right={<Text style={styles.unlimited}>⭐ Unlimited</Text>}
      />
      ...
      <View style={styles.body}>
        ...
        <View style={styles.col}>
          ...
          <View style={styles.field}>
            <Text style={styles.label}>TEAM COLORS & JERSEY</Text>
              ...
              {THEMES.map((th, i) => {
                ...
                return (
                  <Pressable
                    ...
                    style={[styles.swatch, { backgroundColor: th.p }, on && styles.swatchOn]}
                  />
                )
              })}
            </View>
        ...
        {/* Right column: inputs + save button */}
        <ScrollView
          style={styles.col}
